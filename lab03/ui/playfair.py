...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(60, 280, 47, 13))
        self.label_4.setObjectName("label_4")
        self.txt_plain_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(150, 120, 481, 71))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(150, 280, 481, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_key_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key_text.setGeometry(QtCore.QRect(150, 210, 481, 41))
